...
class ProgramParser:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--loc', action='store_true', help='Count the number of lines of code.')
        self.parser.add_argument('--comments', action='store_true', help='Count the number of lines containing comments.')
        self.parser.add_argument('--labels', action='store_true', help='Count the number of label definitions.')
        self.parser.add_argument('--jumps', action='store_true', help='Count the number of jump instructions.')
        self.parser.add_argument('--eol', action='store_true', help='Flag to indicate end-of-line processing.')
        self.parser.add_argument('--print', required=False, type=str, metavar='STRING', help='Prints the specified string.')
        ...
        for arg in sys.argv[1:]:
            if arg.startswith('--stat='):
                ...
                if current_stats_file in self.stats_config:
                    print("Error: cant write two sets of statistics into one file")
                ...
                print("Error: Statistic arguments provided without specifying a --stat file.")
                sys.exit(HELP_ERROR)
